...
# added 25, 50, 75K and 1-5M on 091625
...
mat_thin25K <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin25K.012_conv",
                              header = FALSE, sep = "\t", na.strings = c("NA", "-1"))

mat_thin50K <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin50K.012_conv",
                          header = FALSE, sep = "\t", na.strings = c("NA", "-1"))

mat_thin75K <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin75K.012_conv",
                          header = FALSE, sep = "\t", na.strings = c("NA", "-1"))

mat_thin1M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin1M.012_conv",
                          header = FALSE, sep = "\t", na.strings = c("NA", "-1"))

mat_thin2M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin2M.012_conv",
                          header = FALSE, sep = "\t", na.strings = c("NA", "-1"))

mat_thin3M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin3M.012_conv",
                          header = FALSE, sep = "\t", na.strings = c("NA", "-1"))

mat_thin4M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin4M.012_conv",
                          header = FALSE, sep = "\t", na.strings = c("NA", "-1"))

mat_thin5M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin5M.012_conv",
                          header = FALSE, sep = "\t", na.strings = c("NA", "-1"))
...
ind25K <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin25K.012.indv", header = FALSE)
ind50K <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin50K.012.indv", header = FALSE)
ind75K <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin75K.012.indv", header = FALSE)
ind1M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin1M.012.indv", header = FALSE)
ind2M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin2M.012.indv", header = FALSE)
ind3M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin3M.012.indv", header = FALSE)
ind4M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin4M.012.indv", header = FALSE)
ind5M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin5M.012.indv", header = FALSE)
...
pos25 <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin25K.012.pos", header = FALSE)
pos50 <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin50K.012.pos", header = FALSE)
pos75 <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin75K.012.pos", header = FALSE)
pos1M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin1M.012.pos", header = FALSE)
pos2M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin2M.012.pos", header = FALSE)
pos3M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin3M.012.pos", header = FALSE)
pos4M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin4M.012.pos", header = FALSE)
pos5M <- read.table(file = "rehead_variants_rawfiltered_svit_mem_contam_fastp_bial_noindels_q40_mindep8_maxdep75_maf30_miss90_thin5M.012.pos", header = FALSE)
...
dim(mat_thin4M)
dim(mat_thin5M)
# FOR 100K TO 900K: 208 indivs, snps: 965, 824, 724, 660, 605, 557, 518, 485, 455
# 25K: 208 1136
# 50K: 208 1070
# 75K: 208 1028
# 1M: 208 426
...
all_ones_25K <- apply(mat_thin25K, 2, function(col) all(col ==1))
all_ones_50K <- apply(mat_thin50K, 2, function(col) all(col ==1))
all_ones_75K <- apply(mat_thin75K, 2, function(col) all(col ==1))
all_ones_1M <- apply(mat_thin1M, 2, function(col) all(col ==1))
all_ones_2M <- apply(mat_thin2M, 2, function(col) all(col ==1))
all_ones_3M <- apply(mat_thin3M, 2, function(col) all(col ==1))
all_ones_4M <- apply(mat_thin4M, 2, function(col) all(col ==1))
all_ones_5M <- apply(mat_thin5M, 2, function(col) all(col ==1))
...
mat_thin25K <- mat_thin25K[, !all_ones_25K]
mat_thin50K <- mat_thin50K[, !all_ones_50K]
mat_thin75K <- mat_thin75K[, !all_ones_75K]
...
dim(mat_thin25K) # 1135
dim(mat_thin50K) # 1069
dim(mat_thin75K) # 1027
dim(mat_thin1M) # 426
dim(mat_thin2M) # 282
dim(mat_thin3M) # 216
dim(mat_thin4M) # 178
...
gmr_thin5M <- GetMaybeRel(GenoM = check_thin5M,                               # here
                               ...
                               Tassign = 1.0,
                               # Tfilter = -100,
                               MaxPairs = 7*nrow(check_thin5M))               # here

#unique test f1's in the trios:
length(unique(gmr_thin5M[["MaybeTrio"]]$id[grepl("^SAR_15_67", gmr_thin5M[["MaybeTrio"]]$id)])) # here

# how many unique focal indivs are in the trios?
length(unique(gmr_thin5M[["MaybeTrio"]]$id))                                  # here
# see who it is
...
trios_thin5M <- trios_thin5M %>%                                            # here
...
dim(trios_thin5M_checked)                                                     # here
table(trios_thin5M_checked$valid_cross)                                       # here

length(unique(trios_thin5M_checked$id[grepl("^SAR_15_67", trios_thin5M_checked$id)])) # here
