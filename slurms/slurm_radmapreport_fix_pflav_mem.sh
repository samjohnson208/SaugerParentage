...
## USAGE: sbatch slurm_radmapreport_fix_pflav_mem.sh
...
#SBATCH --mem=10G
#SBATCH -o /project/ysctrout/hatchsauger/SaugerParentage/slurms/std/stdout_radmap_pflav_mem
#SBATCH -e /project/ysctrout/hatchsauger/SaugerParentage/slurms/std/stderr_radmap_pflav_mem
...
cd /project/ysctrout/hatchsauger/sam_sai_pflav_mem/bams/sortedbams
