...
cd /project/ysctrout/hatchsauger/sam_sai_contam_fastp_svit_mem/sorted.bams

# to do here
# make a sorted bams dir and cd to it ^
# make a bams list (see vis stu code)
# set up this script
...
bcftools mpileup -a DP,AD,INFO/AD -C 50 -d 250 -f /project/ysctrout/reference_genomes/Sander_vitreus/walleye_genome.fna -q 30 -Q 20 -I -b bam_list.txt | bcftools call -v -m -f GQ -O z -o variants_rawfiltered_svit_mem_contam_fastp_080925.vcf
