...
#SBATCH -o /project/ysctrout/hatchsauger/SaugerParentage/slurms/std/stdout_count
#SBATCH -e /project/ysctrout/hatchsauger/SaugerParentage/slurms/std/stderr_count
