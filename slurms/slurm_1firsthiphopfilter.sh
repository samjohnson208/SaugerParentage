...
## note: also used 06/15 to filter yellow perch vcfs for pca
...
vcftools --vcf rehead_variants_rawfiltered_pflav_mem_031325.vcf --min-alleles 2 --max-alleles 2 --out variants_bial --recode 
...
vcftools --vcf variants_bial_noindels.recode.vcf --minQ 20 --out variants_pflav_bial_noindels_q20 --recode
