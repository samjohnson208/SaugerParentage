...
## odds library
##########################################################################################
/project/ysctrout/bin/tapioca/src/tap_contam_analysis --db /project/ysctrout/contaminants/illumina_oligos --pct 20 /project/ysctrout/hatchsauger/1Saug/rawreads/test.fastq > test.readstofilter.ill.txt 
# 2> test.readstofilter.ill.stderr
