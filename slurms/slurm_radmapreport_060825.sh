...
# SPJ edits 070825
# USAGE: sbatch slurm_radmapreport_060825.sh /project/ysctrout/hatchsauger/sam_sai_svit_mem/bams/sorted.bams all
...
#SBATCH --mem=16G
#SBATCH -o /project/ysctrout/hatchsauger/SaugerParentage/slurms/std/stdout_radmap_svit_mem
#SBATCH -e /project/ysctrout/hatchsauger/SaugerParentage/slurms/std/stderr_radmap_svit_mem
#SBATCH --mail-type=ALL
#SBATCH --mail-user=sjohn208@uwyo.edu

module load arcc/1.0 gcc/14.2.0 samtools/1.20

# path to your sorted bams
path=$1

# specify all for all libraries
lib=$2
