...
foreach $fastq (@ARGV){
	...
	system "bwa aln -n 4 -l 20 -k 2 -t 32 -R 20 -q 10 -f sam_sai/aln_"."$id".".sai /project/ysctrout/reference_genomes/Perca_flavescens/yellowperch $fastq\n";
	## grep -c 'processor' /proc/cpuinfo  
	## tells you the number of processors on a system
	system "bwa samse -n 1 -r \'\@RG\\tID:LOC_"."$id"."\' -f sam_sai/aln_"."$id".".sam /project/ysctrout/reference_genomes/Perca_flavescens/yellowperch sam_sai/aln_"."$id".".sai $fastq\n";
}
